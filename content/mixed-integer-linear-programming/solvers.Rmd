...
solvers <- tribble(
  ...
  "[CPLEX](https://www.ibm.com/analytics/data-science/prescriptive-analytics/cplex-optimizer)", "Proprietary*", "[cplexAPI](https://CRAN.R-project.org/package=cplexAPI), [Rcplex](https://CRAN.R-project.org/package=Rcplex)", "[Yes](https://CRAN.R-project.org/package=ROI.plugin.cplex)",
