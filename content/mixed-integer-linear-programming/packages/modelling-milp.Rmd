...
This article discribes the modelling techniques available in `ompr` to make your life easier when developing a mixed integer programming model. 

## A first example

The Knapsack problem, as described in the [introduction](/mixed-integer-programming/introduction/) looks like this:
$$
\begin{equation*}
\begin{array}{ll@{}ll}
